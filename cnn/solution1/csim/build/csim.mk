...
HLS_SOURCES = ../../../../digits.cpp ../../../../tb.cpp ../../../../cnn.cpp
...
$(ObjDir)/digits.o: ../../../../digits.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../digits.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/digits.d
