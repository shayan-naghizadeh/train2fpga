...
entity cnn_cnn_Pipeline_VITIS_LOOP_80_1435 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_cnn_Pipeline_VITIS_LOOP_80_1435 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln80_4_fu_371_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln80_4_reg_616 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln80_4_reg_616_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln80_4_reg_616_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln81_15_fu_396_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln79_fu_417_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal phi_urem120_fu_124 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal select_ln80_fu_460_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal phi_mul118_fu_128 : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
    signal add_ln79_fu_401_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal sum_fu_132 : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
    signal ap_sig_allocacmp_sum_load_10 : STD_LOGIC_VECTOR (15 downto 0);
    signal j_fu_136 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal add_ln80_4_fu_377_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal sext_ln81_8_fu_476_p29 : STD_LOGIC_VECTOR (14 downto 0);
    signal sext_ln81_8_fu_476_p30 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p31 : STD_LOGIC_VECTOR (14 downto 0);
    signal sum_10_fu_560_p1 : STD_LOGIC_VECTOR (21 downto 0);
    ...
    signal sext_ln81_8_fu_476_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p5 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p7 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p9 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p11 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p13 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p15 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p17 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p19 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p21 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p23 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p25 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_8_fu_476_p27 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    sparsemux_29_4_15_1_1_U1627 : component cnn_sparsemux_29_4_15_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    port map (
        ...
        def => sext_ln81_8_fu_476_p29,
        sel => sext_ln81_8_fu_476_p30,
        dout => sext_ln81_8_fu_476_p31);

    mac_muladd_15ns_16s_22ns_22_4_1_U1628 : component cnn_mac_muladd_15ns_16s_22ns_22_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 15,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln80_4_fu_371_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    j_fu_136 <= add_ln80_4_fu_377_p2;
                end if;
            end if; 
        end if;
    end process;

    phi_mul118_fu_128_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul118_fu_128 <= ap_const_lv24_0;
                elsif (((icmp_ln80_4_fu_371_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    phi_mul118_fu_128 <= add_ln79_fu_401_p2;
                end if;
            end if; 
        end if;
    end process;

    phi_urem120_fu_124_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    phi_urem120_fu_124 <= ap_const_lv12_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    phi_urem120_fu_124 <= select_ln80_fu_460_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    sum_fu_132 <= sum_10_fu_560_p1(21 downto 6);
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln80_4_reg_616 <= icmp_ln80_4_fu_371_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                icmp_ln80_4_reg_616_pp0_iter2_reg <= icmp_ln80_4_reg_616;
                icmp_ln80_4_reg_616_pp0_iter3_reg <= icmp_ln80_4_reg_616_pp0_iter2_reg;
            end if;
        end if;
    end process;
    ...
    W1_address0 <= zext_ln81_15_fu_396_p1(16 - 1 downto 0);
    ...
    add_ln79_fu_401_p2 <= std_logic_vector(unsigned(phi_mul118_fu_128) + unsigned(ap_const_lv24_124A));
    add_ln80_4_fu_377_p2 <= std_logic_vector(unsigned(j_fu_136) + unsigned(ap_const_lv12_1));
    add_ln80_fu_448_p2 <= std_logic_vector(unsigned(phi_urem120_fu_124) + unsigned(ap_const_lv12_1));
    add_ln81_fu_390_p2 <= std_logic_vector(unsigned(zext_ln81_fu_386_p1) + unsigned(ap_const_lv14_24C0));
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln80_4_fu_371_p2)
    begin
        if (((icmp_ln80_4_fu_371_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_sum_load_10_assign_proc : process(ap_enable_reg_pp0_iter5, ap_block_pp0_stage0, sum_fu_132, sum_10_fu_560_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1))) then 
            ap_sig_allocacmp_sum_load_10 <= sum_10_fu_560_p1(21 downto 6);
        else 
            ap_sig_allocacmp_sum_load_10 <= sum_fu_132;
        end if; 
    end process;
    ...
    grp_fu_578_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln81_8_fu_476_p31),22));
    grp_fu_578_p2 <= (ap_sig_allocacmp_sum_load_10 & ap_const_lv6_0);
    icmp_ln80_4_fu_371_p2 <= "1" when (j_fu_136 = ap_const_lv12_930) else "0";
    ...
    select_ln80_fu_460_p3 <= 
        ...
        ap_const_lv12_0;
    sext_ln81_8_fu_476_p29 <= "XXXXXXXXXXXXXXX";
    sext_ln81_8_fu_476_p30 <= phi_urem120_fu_124(4 - 1 downto 0);
    sum_10_fu_560_p1 <= grp_fu_578_p3;
    sum_17_out <= sum_fu_132;

    sum_17_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln80_4_reg_616_pp0_iter3_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln80_4_reg_616_pp0_iter3_reg = ap_const_lv1_1))) then 
    ...
    tmp_fu_407_p4 <= phi_mul118_fu_128(23 downto 16);
    zext_ln79_fu_417_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_407_p4),64));
    zext_ln81_15_fu_396_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln81_fu_390_p2),64));
