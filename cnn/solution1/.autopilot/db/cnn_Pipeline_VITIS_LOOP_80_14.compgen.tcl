...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_sparsemux_29_4_15_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


set id 1550
set name cnn_mac_muladd_15ns_16s_22ns_22_4_1
...
set ce_signed 0
set out_width 22
set arg_lists {i0 {15 0 +} i1 {16 1 +} m {22 1 +} i2 {22 0 +} p {22 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_5_out { O 16 vector } sum_5_out_ap_vld { O 1 bit } } \
} "
}
