set moduleName cnn_Pipeline_VITIS_LOOP_80_1436
set isTopModule 0
...
set C_modelName {cnn_Pipeline_VITIS_LOOP_80_1436}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_16 int 16 regular  }
	...
	{ sum_20_out int 16 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "sum_16", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_20_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_16 sc_in sc_lv 16 signal 0 } 
	...
	{ sum_20_out sc_out sc_lv 16 signal 16 } 
	{ sum_20_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_16", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sum_16", "role": "default" }} , 
 	...
 	{ "name": "sum_20_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sum_20_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_29_4_15_1_1_U1646", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_15ns_16s_22ns_22_4_1_U1647", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sum_16 { ap_none {  { sum_16 in_data 0 16 } } }
	...
	sum_20_out { ap_vld {  { sum_20_out out_data 1 16 }  { sum_20_out_ap_vld out_vld 1 1 } } }
}
