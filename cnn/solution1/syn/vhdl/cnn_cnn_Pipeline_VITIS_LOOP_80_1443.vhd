...
entity cnn_cnn_Pipeline_VITIS_LOOP_80_1443 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_cnn_Pipeline_VITIS_LOOP_80_1443 is 
    ...
    constant ap_const_lv14_2E40 : STD_LOGIC_VECTOR (13 downto 0) := "10111001000000";
...
attribute shreg_extract : string;
    ...
    signal icmp_ln80_reg_620 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln80_reg_620_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln80_reg_620_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln81_3_fu_400_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln79_fu_421_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal phi_urem160_fu_124 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal select_ln80_fu_464_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal phi_mul158_fu_128 : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
    signal add_ln79_fu_405_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal sum_fu_132 : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
    signal ap_sig_allocacmp_sum_load_2 : STD_LOGIC_VECTOR (15 downto 0);
    signal j_fu_136 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal add_ln80_fu_377_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal zext_ln81_fu_386_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln81_fu_390_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal sext_ln81_fu_396_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_fu_411_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln80_2_fu_452_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal icmp_ln80_2_fu_458_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln81_s_fu_480_p29 : STD_LOGIC_VECTOR (14 downto 0);
    signal sext_ln81_s_fu_480_p30 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p31 : STD_LOGIC_VECTOR (14 downto 0);
    signal sum_2_fu_564_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal grp_fu_582_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal grp_fu_582_p0 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal grp_fu_582_p00 : STD_LOGIC_VECTOR (21 downto 0);
    signal sext_ln81_s_fu_480_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p5 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p7 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p9 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p11 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p13 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p15 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p17 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p19 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p21 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p23 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p25 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln81_s_fu_480_p27 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    sparsemux_29_4_15_1_1_U1779 : component cnn_sparsemux_29_4_15_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    mac_muladd_15ns_16s_22ns_22_4_1_U1780 : component cnn_mac_muladd_15ns_16s_22ns_22_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 15,
    ...
    phi_mul158_fu_128_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul158_fu_128 <= ap_const_lv24_0;
                elsif (((icmp_ln80_fu_371_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    phi_mul158_fu_128 <= add_ln79_fu_405_p2;
                end if;
            end if; 
        end if;
    end process;

    phi_urem160_fu_124_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    phi_urem160_fu_124 <= ap_const_lv12_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    phi_urem160_fu_124 <= select_ln80_fu_464_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    sum_fu_132 <= sum_2_fu_564_p1(21 downto 6);
                end if;
            end if; 
        end if;
    end process;
    ...
    W1_address0 <= zext_ln81_3_fu_400_p1(16 - 1 downto 0);
    ...
    add_ln79_fu_405_p2 <= std_logic_vector(unsigned(phi_mul158_fu_128) + unsigned(ap_const_lv24_124A));
    add_ln80_2_fu_452_p2 <= std_logic_vector(unsigned(phi_urem160_fu_124) + unsigned(ap_const_lv12_1));
    add_ln80_fu_377_p2 <= std_logic_vector(unsigned(j_fu_136) + unsigned(ap_const_lv12_1));
    add_ln81_fu_390_p2 <= std_logic_vector(unsigned(zext_ln81_fu_386_p1) + unsigned(ap_const_lv14_2E40));
    ...
    ap_sig_allocacmp_sum_load_2_assign_proc : process(ap_enable_reg_pp0_iter5, ap_block_pp0_stage0, sum_fu_132, sum_2_fu_564_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1))) then 
            ap_sig_allocacmp_sum_load_2 <= sum_2_fu_564_p1(21 downto 6);
        else 
            ap_sig_allocacmp_sum_load_2 <= sum_fu_132;
        end if; 
    end process;

    flattened_output_10_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_11_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_12_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_13_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_1_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_2_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_3_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_4_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_5_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_6_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_7_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_8_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_9_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    flattened_output_address0 <= zext_ln79_fu_421_p1(8 - 1 downto 0);
    ...
    grp_fu_582_p0 <= grp_fu_582_p00(15 - 1 downto 0);
    grp_fu_582_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln81_s_fu_480_p31),22));
    grp_fu_582_p2 <= (ap_sig_allocacmp_sum_load_2 & ap_const_lv6_0);
    icmp_ln80_2_fu_458_p2 <= "1" when (unsigned(add_ln80_2_fu_452_p2) < unsigned(ap_const_lv12_E)) else "0";
    icmp_ln80_fu_371_p2 <= "1" when (j_fu_136 = ap_const_lv12_930) else "0";
    select_ln80_fu_464_p3 <= 
        add_ln80_2_fu_452_p2 when (icmp_ln80_2_fu_458_p2(0) = '1') else 
        ap_const_lv12_0;
        sext_ln81_fu_396_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln81_fu_390_p2),15));

    sext_ln81_s_fu_480_p29 <= "XXXXXXXXXXXXXXX";
    sext_ln81_s_fu_480_p30 <= phi_urem160_fu_124(4 - 1 downto 0);
    sum_2_fu_564_p1 <= grp_fu_582_p3;
    sum_41_out <= sum_fu_132;

    sum_41_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln80_reg_620_pp0_iter3_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln80_reg_620_pp0_iter3_reg = ap_const_lv1_1))) then 
    ...
    tmp_fu_411_p4 <= phi_mul158_fu_128(23 downto 16);
    zext_ln79_fu_421_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_411_p4),64));
    zext_ln81_3_fu_400_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln81_fu_396_p1),64));
    zext_ln81_fu_386_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_fu_136),14));
end behav;
