...
module cnn_cnn_Pipeline_VITIS_LOOP_80_1436 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln80_5_fu_371_p2;
reg    ap_condition_exit_pp0_iter1_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln80_5_reg_616;
reg   [0:0] icmp_ln80_5_reg_616_pp0_iter2_reg;
reg   [0:0] icmp_ln80_5_reg_616_pp0_iter3_reg;
wire   [63:0] zext_ln81_14_fu_396_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln79_fu_417_p1;
reg   [11:0] phi_urem125_fu_124;
wire   [11:0] select_ln80_fu_460_p3;
wire    ap_loop_init;
reg   [23:0] phi_mul123_fu_128;
wire   [23:0] add_ln79_fu_401_p2;
reg   [15:0] sum_fu_132;
reg   [15:0] ap_sig_allocacmp_sum_load_9;
reg   [11:0] j_fu_136;
wire   [11:0] add_ln80_5_fu_377_p2;
...
#0 phi_urem125_fu_124 = 12'd0;
#0 phi_mul123_fu_128 = 24'd0;
#0 sum_fu_132 = 16'd0;
#0 j_fu_136 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
cnn_mac_muladd_15ns_16s_22ns_22_4_1 #(
    ...
    .din2_WIDTH( 22 ),
    .dout_WIDTH( 22 ))
mac_muladd_15ns_16s_22ns_22_4_1_U1647(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_578_p0),
    .din1(W1_q0),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            j_fu_136 <= 12'd0;
        end else if (((icmp_ln80_5_fu_371_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            sum_fu_132 <= {{sum_9_fu_560_p1[21:6]}};
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln80_5_fu_371_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter5 == 1'b1))) begin
        ap_sig_allocacmp_sum_load_9 = {{sum_9_fu_560_p1[21:6]}};
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln80_5_reg_616_pp0_iter3_reg == 1'd1))) begin
...
assign W1_address0 = zext_ln81_14_fu_396_p1;

assign add_ln79_fu_401_p2 = (phi_mul123_fu_128 + 24'd4682);

assign add_ln80_5_fu_377_p2 = (j_fu_136 + 12'd1);

assign add_ln80_fu_448_p2 = (phi_urem125_fu_124 + 12'd1);

assign add_ln81_fu_390_p2 = ($signed(zext_ln81_fu_386_p1) + $signed(14'd11760));
...
assign grp_fu_578_p2 = {{ap_sig_allocacmp_sum_load_9}, {6'd0}};

assign icmp_ln80_5_fu_371_p2 = ((j_fu_136 == 12'd2352) ? 1'b1 : 1'b0);
...
assign sext_ln81_s_fu_476_p30 = phi_urem125_fu_124[3:0];

assign sum_20_out = sum_fu_132;

assign sum_9_fu_560_p1 = grp_fu_578_p3;

assign tmp_fu_407_p4 = {{phi_mul123_fu_128[23:16]}};

assign zext_ln79_fu_417_p1 = tmp_fu_407_p4;

assign zext_ln81_14_fu_396_p1 = add_ln81_fu_390_p2;

assign zext_ln81_fu_386_p1 = j_fu_136;

endmodule //cnn_cnn_Pipeline_VITIS_LOOP_80_1436
