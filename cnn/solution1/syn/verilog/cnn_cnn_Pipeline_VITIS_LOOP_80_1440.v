...
module cnn_cnn_Pipeline_VITIS_LOOP_80_1440 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln81_10_fu_396_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln79_fu_417_p1;
reg   [11:0] phi_urem145_fu_124;
wire   [11:0] select_ln80_fu_460_p3;
wire    ap_loop_init;
reg   [23:0] phi_mul143_fu_128;
wire   [23:0] add_ln79_fu_401_p2;
reg   [15:0] sum_fu_132;
reg   [15:0] ap_sig_allocacmp_sum_load_5;
reg   [11:0] j_fu_136;
...
#0 phi_urem145_fu_124 = 12'd0;
#0 phi_mul143_fu_128 = 24'd0;
#0 sum_fu_132 = 16'd0;
#0 j_fu_136 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
cnn_mac_muladd_15ns_16s_22ns_22_4_1 #(
    ...
    .din2_WIDTH( 22 ),
    .dout_WIDTH( 22 ))
mac_muladd_15ns_16s_22ns_22_4_1_U1723(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_578_p0),
    .din1(W1_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            sum_fu_132 <= {{sum_5_fu_560_p1[21:6]}};
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter5 == 1'b1))) begin
        ap_sig_allocacmp_sum_load_5 = {{sum_5_fu_560_p1[21:6]}};
    end else begin
...
assign W1_address0 = zext_ln81_10_fu_396_p1;

assign add_ln79_fu_401_p2 = (phi_mul143_fu_128 + 24'd4682);

assign add_ln80_5_fu_448_p2 = (phi_urem145_fu_124 + 12'd1);

assign add_ln80_fu_377_p2 = (j_fu_136 + 12'd1);

assign add_ln81_fu_390_p2 = ($signed(zext_ln81_fu_386_p1) + $signed(15'd21168));
...
assign grp_fu_578_p2 = {{ap_sig_allocacmp_sum_load_5}, {6'd0}};

assign icmp_ln80_5_fu_454_p2 = ((add_ln80_5_fu_448_p2 < 12'd14) ? 1'b1 : 1'b0);

assign icmp_ln80_fu_371_p2 = ((j_fu_136 == 12'd2352) ? 1'b1 : 1'b0);

assign select_ln80_fu_460_p3 = ((icmp_ln80_5_fu_454_p2[0:0] == 1'b1) ? add_ln80_5_fu_448_p2 : 12'd0);

assign sext_ln81_s_fu_476_p29 = 'bx;

assign sext_ln81_s_fu_476_p30 = phi_urem145_fu_124[3:0];

assign sum_32_out = sum_fu_132;

assign sum_5_fu_560_p1 = grp_fu_578_p3;

assign tmp_fu_407_p4 = {{phi_mul143_fu_128[23:16]}};

assign zext_ln79_fu_417_p1 = tmp_fu_407_p4;

assign zext_ln81_10_fu_396_p1 = add_ln81_fu_390_p2;

assign zext_ln81_fu_386_p1 = j_fu_136;

endmodule //cnn_cnn_Pipeline_VITIS_LOOP_80_1440
